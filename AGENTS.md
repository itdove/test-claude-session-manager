# Sample AGENTS.md for cs Tool Integration

This is a sample AGENTS.md file showing how to configure Claude to use the `cs` tool (Claude Session Manager) in your projects. Copy the relevant sections to your project's AGENTS.md file.
...
**Note**: This sample is project-agnostic. Customize the project key, workstream, epic IDs, and templates to match your specific project.
...
cs config context add https://github.com/Ansible-SaaS/.github/blob/main/STANDARDS.md "coding standards"
...
```bash
# Install cs with pipx
pipx install claude-session-manager

# Or reinstall
pipx reinstall claude-session-manager
```
...
# If using git@gitlab.cee.redhat.com:..., use --git-protocol git
# If using https://gitlab.cee.redhat.com/..., use --git-protocol https
```
